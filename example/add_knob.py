    ...
    WidgetbookUseCase(
      ...
      builder: (context) {
        ...
        return ComponentDocs(
          name: 'Journey Progress Indicator',
          description: 'A progress stepper component indicating the current stage of a multi-step journey, used primarily in application and submission flows. Use the [Variant] knob to toggle layouts.',
          code: code,
          center: true,
          child: child,
        );
...
const _journeyProgressIndicatorDefaultCode = r"""import 'package:flutter/material.dart';
import 'package:ux4g_flutter_design_system/ux4g_flutter_design_system.dart';
import 'package:flutter_svg/flutter_svg.dart';
...
const _journeyProgressIndicatorCardCode = r"""import 'package:flutter/material.dart';
import 'package:ux4g_flutter_design_system/ux4g_flutter_design_system.dart';
import 'package:flutter_svg/flutter_svg.dart';
...
class _JourneyProgressIndicatorCardMockup extends StatefulWidget {
  ...
  @override
  State<_JourneyProgressIndicatorCardMockup> createState() => _JourneyProgressIndicatorCardMockupState();
}

class _JourneyProgressIndicatorCardMockupState extends State<_JourneyProgressIndicatorCardMockup> {
  bool _acceptTerms = false;
  String _fullName = '';
  String _panNumber = '';
...
print("Added variant knob for Journey Progress Indicator.")
