  ...
  useCases: [
    WidgetbookUseCase(
      ...
      builder: (context) => ComponentDocs(
        name: 'Ux4gAvatar',
        description: 'A circular avatar that can display an icon placeholder, initials, or a network image. '
...
Ux4gAvatar(imageUrl: 'https://example.com/photo.jpg', size: Ux4gAvatarSize.l);''',
        ...
        child: Ux4gAvatar(
          size: context.knobs.list(
            ...
            initialOption: Ux4gAvatarSize.m, labelBuilder: (v) => v.name,
          ),
        ),
      ),
    ),
...
final profileAvatarComponent = WidgetbookComponent(
  ...
  useCases: [
    WidgetbookUseCase(
      ...
      builder: (context) => ComponentDocs(
        name: 'Ux4gProfileAvatar',
        description: 'Avatar with a status or role badge overlay. Supports verified, star, and admin badges, '
        ...
        child: Row(
          ...
          children: Ux4gProfileBadge.values
              .map((b) => Padding(
                    ...
                    child: Ux4gProfileAvatar(initials: 'AB', variant: b, size: Ux4gAvatarSize.l),
                  ))
              .toList(),
        ),
      ),
...
final statusAvatarComponent = WidgetbookComponent(
  ...
  useCases: [
    WidgetbookUseCase(
      ...
      builder: (context) => ComponentDocs(
        name: 'Ux4gStatusAvatar',
        description: 'Avatar with a presence/status dot: online, offline, busy, success, error, warning.',
  ...
  size: Ux4gAvatarSize.l,
        ...
        child: Row(
          ...
          children: Ux4gStatusVariant.values
              .map((s) => Padding(
                    padding: const EdgeInsets.symmetric(horizontal: 6),
                    child: Ux4gStatusAvatar(initials: 'AB', variant: s, size: Ux4gAvatarSize.l),
                  ))
              .toList(),
        ),
      ),
...
final avatarGroupComponent = WidgetbookComponent(
  ...
  useCases: [
    WidgetbookUseCase(
      ...
      builder: (context) => ComponentDocs(
        name: 'Ux4gAvatarGroup',
        description: 'A stacked row of avatars with an overflow count pill when items exceed maxLimit.',
  ...
  maxLimit: 3,   // shows "+2" overflow
        ...
        child: Ux4gAvatarGroup(
          ...
          maxLimit: context.knobs.int.input(label: 'Max visible', initialValue: 3),
        ),
      ),
    ),
  ],
