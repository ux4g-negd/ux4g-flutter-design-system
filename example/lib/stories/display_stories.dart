...
Ux4gTag(text: 'Close me', onDismiss: () {});''',
        props: const [
          ...
          PropRow(name: 'shape', type: 'Ux4gTagShape', description: 'circular / rectangular.', defaultValue: 'circular'),
          PropRow(name: 'leadingContent', type: 'Widget?', description: 'Widget shown before text.'),
          PropRow(name: 'onDismiss', type: 'VoidCallback?', description: 'Shows × button when provided.'),
          PropRow(name: 'customBackgroundColor', type: 'Color?', description: 'Background color override.'),
          PropRow(name: 'customContentColor', type: 'Color?', description: 'Text/icon color override.'),
          PropRow(name: 'customBorderColor', type: 'Color?', description: 'Border color override.'),
          PropRow(name: 'customBorderRadius', type: 'BorderRadius?', description: 'Border radius override.'),
        ],
        child: Wrap(
    ...
    WidgetbookUseCase(
      ...
      builder: (context) => ComponentDocs(
        ...
        description: 'A pill-shaped tag containing multiple segments separated by dividers.',
  ...
  segments: [
    ...
    Ux4gPillSegment(text: 'Pending', bold: true, textColor: Colors.orange),
        ...
        props: const [
          PropRow(name: 'segments', type: 'List<Ux4gPillSegment>', description: 'List of segments to display.', required: true),
          PropRow(name: 'size', type: 'Ux4gTagSize', description: 'm / l.', defaultValue: 'l'),
          PropRow(name: 'backgroundColor', type: 'Color?', description: 'Container background.'),
          PropRow(name: 'borderColor', type: 'Color?', description: 'Container border.'),
          PropRow(name: 'dividerColor', type: 'Color?', description: 'Divider between segments.'),
          PropRow(name: 'customBorderRadius', type: 'BorderRadius?', description: 'Corner radius override.'),
        ],
...
Ux4gCard(
  ...
  onSecondaryClick: () {},
        ...
        props: const [
          ...
          PropRow(name: 'cornerRadius', type: 'double', description: 'Corner radius.', defaultValue: 'Ux4gRadius.radius12'),
          PropRow(name: 'backgroundColor', type: 'Color?', description: 'Background color.'),
          PropRow(name: 'borderColor', type: 'Color', description: 'Border color.', defaultValue: 'Colors.transparent'),
          PropRow(name: 'borderWidth', type: 'double', description: 'Border width.', defaultValue: '0'),
          PropRow(name: 'elevation', type: 'double', description: 'Elevation.', defaultValue: '0'),
          PropRow(name: 'isClickable', type: 'bool', description: 'Enables ink well ripple.', defaultValue: 'false'),
          PropRow(name: 'onPressed', type: 'VoidCallback?', description: 'Click callback.'),
          PropRow(name: 'direction', type: 'Ux4gCardDirection', description: 'vertical / horizontal.', defaultValue: 'vertical'),
          PropRow(name: 'mediaImageUrl', type: 'String?', description: 'Hero image URL.'),
          PropRow(name: 'mediaHeight', type: 'double', description: 'Hero image height (vertical only).', defaultValue: '180'),
          PropRow(name: 'mediaWidth', type: 'double', description: 'Thumbnail width (horizontal only).', defaultValue: '120'),
          PropRow(name: 'mediaLabelText', type: 'String?', description: 'Label badge on top of media.'),
          PropRow(name: 'avatar', type: 'Widget?', description: 'Leading avatar in header.'),
          PropRow(name: 'title', type: 'String?', description: 'Heading text.'),
          PropRow(name: 'subtitle', type: 'String?', description: 'Supporting text below title.'),
          PropRow(name: 'statusChips', type: 'List<String>', description: 'Chips shown in header row.', defaultValue: '[]'),
          PropRow(name: 'body', type: 'String?', description: 'Main paragraph text.'),
          PropRow(name: 'bottomChips', type: 'List<String>', description: 'Pill chips below body text.', defaultValue: '[]'),
          PropRow(name: 'footerType', type: 'Ux4gCardFooterType', description: 'Buttons layout.', defaultValue: 'none'),
          PropRow(name: 'footerAlignment', type: 'Ux4gCardFooterAlignment', description: 'left / centered / right.', defaultValue: 'left'),
          ...
          PropRow(name: 'onPrimaryClick', type: 'VoidCallback?', description: 'Primary action callback.'),
          PropRow(name: 'onSecondaryClick', type: 'VoidCallback?', description: 'Secondary action callback.'),
        ],
        child: SizedBox(
          width: 320,
          child: Ux4gCard(
...
Ux4gDivider(label: Text('OR'))''',
        props: const [
          ...
          PropRow(name: 'thickness', type: 'double', description: 'Stroke thickness.', defaultValue: '1.0'),
          PropRow(name: 'style', type: 'Ux4gDividerStyle', description: 'solid / dashed / dotted.', defaultValue: 'solid'),
          PropRow(name: 'startIndent', type: 'double', description: 'Leading gap.', defaultValue: '0.0'),
          PropRow(name: 'endIndent', type: 'double', description: 'Trailing gap.', defaultValue: '0.0'),
          PropRow(name: 'label', type: 'Widget?', description: 'Widget placed in the centre of the line.'),
          PropRow(name: 'labelSpacing', type: 'double', description: 'Gap between line and label.', defaultValue: '8.0'),
        ],
