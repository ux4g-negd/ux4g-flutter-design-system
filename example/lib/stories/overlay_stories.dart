...
final modalComponent = WidgetbookComponent(
  ...
  onDismiss: () {},
        ...
        props: const [
          ...
          PropRow(name: 'showSubtitle', type: 'bool', description: 'Show subtitle below the header divider.', defaultValue: 'true'),
          ...
          PropRow(name: 'bodyText', type: 'String', description: 'Body paragraph.'),
          PropRow(name: 'showFooter', type: 'bool', description: 'Show footer buttons.', defaultValue: 'true'),
          PropRow(name: 'footerButtons', type: 'Ux4gModalFooterButtons', description: 'oneButton / twoButtons / oneButtonWithIcon / twoButtonsWithIcon.', defaultValue: 'oneButton'),
    ...
    WidgetbookUseCase(
      ...
      builder: (context) => ComponentDocs(
        ...
        description:
            ...
            'Tap the trigger to show. Use Ux4gRichTooltip for icon + title + action.',
        code: '''// Simple tooltip
Ux4gTooltip(
  ...
  child: Icon(Icons.help_outline),
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 60),
            const Text('Rich Tooltip:', style: TextStyle(fontWeight: FontWeight.w600)),
