      ...
      builder: (context) {
        ...
        return StatefulBuilder(builder: (ctx, setState) {
          return ComponentDocs(
            name: 'Ux4gStepper',
            description: 'A multi-step progress indicator for form wizards. '
...
Ux4gCapsuleStepper(
  ...
  onPrevious: () {},
            ...
            props: const [
              PropRow(name: 'totalSteps', type: 'int', description: 'Total number of steps.', required: true),
              PropRow(name: 'currentStep', type: 'int', description: 'Zero-based active step index.', required: true),
...
final resultRowComponent = WidgetbookComponent(
  ...
  useCases: [
    WidgetbookUseCase(
      ...
      builder: (context) => ComponentDocs(
        name: 'Ux4gResultRow',
        description: 'An expandable list-row that summarises a record with a status tag, '
        ...
        child: SizedBox(
          ...
          child: Ux4gResultRow(
            ...
            details: const [
              Ux4gResultDetail(label: 'Applicant', value: 'Ravi Kumar'),
              Ux4gResultDetail(label: 'Date', value: '12 May 2025'),
              Ux4gResultDetail(label: 'Amount', value: '₹1,20,000', isBold: true),
            ],
          ),
        ),
      ),
...
final socialLinkComponent = WidgetbookComponent(
  ...
  useCases: [
    WidgetbookUseCase(
      ...
      builder: (context) => ComponentDocs(
        name: 'Ux4gSocialLink',
        description: 'SVG social-media icon buttons. Choose from the SocialMediaIcon enum. '
  ...
  containerSize: 48,
        ...
        child: Wrap(
          ...
          children: [
            ...
            Ux4gSocialLink(icon: SocialMediaIcon.instagram, useColoredIcon: true),
...
final journeyTimelineComponent = WidgetbookComponent(
  ...
  useCases: [
    WidgetbookUseCase(
      ...
      builder: (context) => ComponentDocs(
        name: 'Ux4gJourneyTimeline',
        description: 'A vertical timeline showing the progress of a multi-stage journey. '
      ...
      state: Ux4gJourneyStepState.upcoming,
        ...
        child: SizedBox(
          ...
          child: Ux4gJourneyTimeline(
            currentStep: 1,
            steps: const [
              Ux4gJourneyStep(title: 'Application Submitted', date: '01 Jan 2025', state: Ux4gJourneyStepState.completed),
              Ux4gJourneyStep(title: 'Under Review', date: '05 Jan 2025', state: Ux4gJourneyStepState.current),
              Ux4gJourneyStep(title: 'Approval Pending', date: 'Upcoming', state: Ux4gJourneyStepState.upcoming),
              Ux4gJourneyStep(title: 'Disbursement', state: Ux4gJourneyStepState.upcoming),
            ],
          ),
        ),
      ),
...
final statusPipelineComponent = WidgetbookComponent(
  ...
  useCases: [
    WidgetbookUseCase(
      ...
      builder: (context) => ComponentDocs(
        name: 'Ux4gStatusPipeline',
        description: 'A horizontal pipeline showing discrete processing stages. '
  ...
  steps: const [
    ...
    Ux4gPipelineStep(label: 'Disbursed', description: 'Est. 12 Apr'),
        ...
        props: const [
          PropRow(name: 'steps', type: 'List<Ux4gPipelineStep>', description: 'Pipeline stages.', required: true),
          PropRow(name: 'currentStep', type: 'int', description: 'Active stage index.', required: true),
        ],
        child: SizedBox(
          width: 380,
...
final carouselComponent = WidgetbookComponent(
  ...
  useCases: [
    WidgetbookUseCase(
      ...
      builder: (context) => ComponentDocs(
        name: 'Ux4gCarousel',
        description: 'A horizontal swipe carousel. Pass any list of widgets as items.',
        code: '''Ux4gCarousel(
  items: List.generate(
    4,
    (i) => Image.network(
      ...
      fit: BoxFit.cover,
        ...
        props: const [
          PropRow(name: 'items', type: 'List<Widget>', description: 'Carousel slide widgets.', required: true),
        ],
        child: SizedBox(
          width: 360,
          child: Ux4gCarousel(
            items: List.generate(
              4,
              (i) => Image.network('https://picsum.photos/seed//360/200', fit: BoxFit.cover),
            ),
          ),
        ),
      ),
...
final socialLinkGroupComponent = WidgetbookComponent(
  ...
  spacing: 12,
        ...
        props: const [
          PropRow(name: 'icons', type: 'List<SocialMediaIcon>', description: 'Social icons to display.', required: true),
          PropRow(name: 'size', type: 'SocialLinkSize', description: 'xs / s / m / l / xl / xxl.', defaultValue: 'm'),
          PropRow(name: 'enableBackground', type: 'bool', description: 'Show background circle per icon.', defaultValue: 'false'),
          PropRow(name: 'spacing', type: 'double', description: 'Gap between icons.', defaultValue: '8'),
          PropRow(name: 'onIconPressed', type: 'Function(SocialMediaIcon)?', description: 'Called when an icon is tapped.'),
        ],
        child: Ux4gSocialLinkGroup(
          ...
          enableBackground: context.knobs.boolean(label: 'Background', initialValue: false),
          onIconPressed: (icon) => () {},
        ),
      ),
    ),
...
final socialLinkListComponent = WidgetbookComponent(
  ...
  enableBackground: true,
        ...
        props: const [
          PropRow(name: 'icons', type: 'List<SocialMediaIcon>', description: 'Social icons to display.', required: true),
          PropRow(name: 'size', type: 'SocialLinkSize', description: 'xs / s / m / l / xl / xxl.', defaultValue: 'm'),
          PropRow(name: 'direction', type: 'Axis', description: 'horizontal or vertical.', defaultValue: 'horizontal'),
          PropRow(name: 'alignment', type: 'MainAxisAlignment', description: 'Flex alignment.', defaultValue: 'start'),
          PropRow(name: 'enableBackground', type: 'bool', description: 'Show background circle per icon.', defaultValue: 'false'),
          PropRow(name: 'onIconPressed', type: 'Function(SocialMediaIcon)?', description: 'Called when an icon is tapped.'),
        ],
        child: Ux4gSocialLinkList(
          ...
          enableBackground: context.knobs.boolean(label: 'Background', initialValue: true),
