...
Ux4gInputField(
  ...
  showPasswordToggle: true,
            ...
            props: const [
              ...
              PropRow(name: 'status', type: 'Ux4gInputFieldStatus', description: 'default / error / warning / success.', defaultValue: 'defaultStatus'),
...
Ux4gCheckbox(value: null, onChanged: (v) {}, label: 'Partial');''',
            props: const [
              PropRow(name: 'value', type: 'bool?', description: 'true / false / null (indeterminate).', required: true),
              ...
              PropRow(name: 'description', type: 'String?', description: 'Helper text below label.'),
...
final datePickerComponent = WidgetbookComponent(
  ...
  onDateSelected: (date) {
    print('Selected: \$date');
            ...
            props: const [
              PropRow(name: 'mode', type: 'Ux4gDatePickerMode', description: 'single — single date selection.', defaultValue: 'single'),
              PropRow(name: 'placeholder', type: 'String', description: 'Hint text shown when no date is selected.', defaultValue: '"Select date"'),
              PropRow(name: 'initialDate', type: 'DateTime?', description: 'Pre-selected date.'),
              ...
              PropRow(name: 'onDateSelected', type: 'ValueChanged<DateTime>?', description: 'Callback with the chosen date.'),
