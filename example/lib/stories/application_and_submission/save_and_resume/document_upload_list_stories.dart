...
final documentUploadListComponent = WidgetbookComponent(
    ...
    WidgetbookUseCase(
      ...
      builder: (context) {
        ...
        final code = variant == 'Card style'
            ? _documentUploadListCardCode
            : _documentUploadListDefaultCode;
        final child = variant == 'Card style'
            ? const _DocumentUploadListCardMockup()
            : const _DocumentUploadListMockup();

        return ComponentDocs(
          mobileMockup: true,
          name: 'Document Upload List',
          description:
              'A pattern showing a document upload checklist with auto-save, '
              'uploaded file status, required/optional badges, and DigiLocker integration.',
          code: code,
          center: true,
          child: child,
        );
      ...
      child: Column(
        ...
        children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    const Text(
                      'Aadhaar Card',
                      style: TextStyle(fontSize: 15, fontWeight: FontWeight.w600, color: _titleColor),
                    ),
          ...
          Padding(
            ...
            child: Row(
              children: [
                _SmallOutlineButton(label: 'View'),
                const SizedBox(width: 8),
                _SmallOutlineButton(label: 'Re-upload'),
              ],
            ),
          ),
        ],
...
class _SmallOutlineButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Text(
        label,
        style: const TextStyle(fontSize: 13, fontWeight: FontWeight.w500, color: _titleColor),
      ),
    );
  }
}
...
class _SavedIndicator extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Ux4gStatusBanner(
      ...
      leadingIcon: const Icon(Icons.check_circle, color: _greenColor, size: 18),
      titleStyle: const TextStyle(color: _greenColor, fontWeight: FontWeight.w500, fontSize: 13),
...
const _documentUploadListDefaultCode = r"""import 'package:flutter/material.dart';
import 'package:ux4g_flutter_design_system/ux4g_flutter_design_system.dart';
import 'package:flutter_svg/flutter_svg.dart';

class DocumentUploadListScreen extends StatelessWidget {
  const DocumentUploadListScreen({super.key});
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Ux4gStatusBanner(
                      ...
                      title: 'Saved 3:14 PM',
                      margin: EdgeInsets.zero,
                      leadingIcon: const Icon(Icons.check_circle, color: greenColor, size: 18),
                      titleStyle: const TextStyle(color: greenColor, fontWeight: FontWeight.w500, fontSize: 13),
                      padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 10),
                    ),
                    ...
                    // Pending document: Proof of Income
                    Container(
                      padding: const EdgeInsets.all(16),
                      decoration: BoxDecoration(
                        border: Border.all(color: const Color(0xFFE5E7EB)),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const Padding(
                            ...
                            child: Text('Salary slip or income tax return', style: TextStyle(fontSize: 13, color: subtleText)),
                          ),
                          const SizedBox(height: 12),
                          Padding(
                            padding: const EdgeInsets.only(left: 40),
                    ...
                    // Pending document: Residence proof
                    Container(
                      padding: const EdgeInsets.all(16),
                      decoration: BoxDecoration(
                        border: Border.all(color: const Color(0xFFE5E7EB)),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const Padding(
                            padding: EdgeInsets.only(left: 40, top: 4),
                            child: Text('Electricity bill, gas bill or ration card', style: TextStyle(fontSize: 13, color: subtleText)),
                          ),
                          const SizedBox(height: 12),
                          Padding(
                            padding: const EdgeInsets.only(left: 40),
                    ...
                    // Optional document: Caste certificate
                    Container(
                      padding: const EdgeInsets.all(16),
                      decoration: BoxDecoration(
                        border: Border.all(color: const Color(0xFFE5E7EB)),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const Padding(
                            padding: EdgeInsets.only(left: 40, top: 4),
                            child: Text('SC/ST/OBC applicants only', style: TextStyle(fontSize: 13, color: subtleText)),
                          ),
                          const SizedBox(height: 12),
                          Padding(
                            padding: const EdgeInsets.only(left: 40),
            ...
            Padding(
              ...
              child: Column(
                children: [
                  ...
                  const SizedBox(height: 12),
                  Ux4gButton(text: 'Back', onPressed: () {}, variant: Ux4gButtonVariant.outline, size: Ux4gButtonSize.large, width: double.infinity, contentColor: const Color(0xFF6B7280), borderColor: const Color(0xFFD1D5DB)),
                ],
              ),
            ),
...
const _documentUploadListCardCode = r"""import 'package:flutter/material.dart';
import 'package:ux4g_flutter_design_system/ux4g_flutter_design_system.dart';
import 'package:flutter_svg/flutter_svg.dart';

class DocumentUploadListCardScreen extends StatelessWidget {
  const DocumentUploadListCardScreen({super.key});
...
class _DocumentUploadListMockup extends StatelessWidget {
  const _DocumentUploadListMockup();
...
class _DocumentUploadListCardMockup extends StatelessWidget {
  const _DocumentUploadListCardMockup();
