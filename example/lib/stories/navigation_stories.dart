        ...
        return StatefulBuilder(
          builder: (ctx, setState) {
            return ComponentDocs(
              name: 'Ux4gAccordion',
              description:
                  'A collapsible panel. Toggle with onExpandedChange. '
  ...
  child: Text('Content here'),
              ...
              props: const [
                ...
                PropRow(
                  name: 'expanded',
                  type: 'bool',
                  description: 'Current expanded state.',
                  defaultValue: 'false',
                ),
                PropRow(
                  name: 'enabled',
                  type: 'bool',
                  description:
                      'When false, header is grayed out and non-interactive.',
                  defaultValue: 'true',
                ),
                PropRow(
                  name: 'onExpandedChange',
                  type: 'ValueChanged<bool>?',
                  description: 'Called when the panel is toggled.',
                ),
                PropRow(
                  name: 'backgroundColor',
                  type: 'Color?',
                  description:
                      'Header background. Defaults to colors.surface (theme-aware).',
                ),
                PropRow(
                  name: 'contentBackgroundColor',
                  type: 'Color?',
                  description:
                      'Background of the expanded content area only. Defaults to colors.surface.',
                ),
                PropRow(
                  name: 'collapsedBorderColor',
                  type: 'Color?',
                  description:
                      'Border when collapsed. Defaults to colors.onSurface at 12% opacity (theme-aware).',
                ),
                PropRow(
                  name: 'expandedBorderColor',
                  type: 'Color?',
                  description:
                      'Border when expanded. Defaults to colors.primary (theme-aware).',
                ),
                PropRow(
                  name: 'titleColor',
                  type: 'Color?',
                  description:
                      'Title text color. Defaults to colors.onSurface (theme-aware).',
                ),
                PropRow(
                  name: 'disabledTitleColor',
                  type: 'Color?',
                  description:
                      'Title color when disabled. Defaults to colors.onSurface at 38% opacity.',
                ),
                PropRow(
                  name: 'iconColor',
                  type: 'Color?',
                  description:
                      'Chevron icon color. Defaults to colors.onSurface (theme-aware).',
                ),
                PropRow(
                  name: 'disabledIconColor',
                  type: 'Color?',
                  description:
                      'Chevron color when disabled. Defaults to colors.onSurface at 38% opacity.',
                ),
              ],
              child: SizedBox(
                width: 340,
    ...
    WidgetbookUseCase(
      ...
      builder: (context) => ComponentDocs(
        ...
        code:
            'Ux4gAccordion(title: \'Locked\', expanded: false, enabled: false, onExpandedChange: (_) {});',
        child: SizedBox(
          width: 340,
          child: Ux4gAccordion(
          ...
          builder: (ctx, setState) {
            ...
            return ComponentDocs(
              ...
              props: const [
                PropRow(
                  name: 'items',
                  type: 'List<Ux4gAccordionItem>',
                  description: 'List of accordion items (title + enabled).',
                  required: true,
                ),
                PropRow(
                  name: 'contentBuilder',
                  type: 'Widget Function(int, Ux4gAccordionItem)',
                  description:
                ...
                PropRow(
                  ...
                  type: 'int?',
                  description:
                      'Index of the currently expanded item. null = all collapsed.',
                ),
                PropRow(
                  name: 'onExpandedIndexChange',
                  type: 'ValueChanged<int?>?',
                  description:
                      'Called when an item is toggled. null means collapsed.',
                ),
                PropRow(
                  name: 'itemSpacing',
                  type: 'double',
                  description: 'Vertical gap between accordion items.',
                  defaultValue: 'Ux4gSpace.space20',
                ),
              ],
              child: SizedBox(
                width: 340,
...
final statusBannerComponent = WidgetbookComponent(
  ...
  useCases: [
    WidgetbookUseCase(
      ...
      builder: (context) => ComponentDocs(
        name: 'Ux4gStatusBanner',
        description:
            'Notification banners with semantic colour variants including light and solid options.',
  ...
  onDismiss: () {},
        ...
        props: const [
          PropRow(
            name: 'variant',
            type: 'Ux4gBannerVariant',
            description:
                'warningLight / warningSolid / errorLight / successLight / savingLight / infoLight / neutralLight / primaryLight.',
            required: true,
          ),
          PropRow(
            name: 'title',
          ...
          PropRow(
            name: 'titleStyle',
            type: 'TextStyle?',
            description: 'Custom style for title.',
          ),
          PropRow(
            name: 'subtitleStyle',
            type: 'TextStyle?',
            description: 'Custom style for subtitle.',
          ),
          PropRow(
            name: 'badge',
            type: 'Widget?',
            description: 'Small badge shown next to title.',
          ),
          PropRow(
            name: 'leadingIcon',
            type: 'Widget?',
            description: 'Custom icon on the left.',
          ),
          PropRow(
            name: 'trailingIcon',
            type: 'Widget?',
            description: 'Custom icon on the right.',
          ),
          PropRow(
            name: 'actions',
            type: 'List<Widget>?',
    ...
    WidgetbookUseCase(
      ...
      builder: (context) => ComponentDocs(
        ...
        description:
            'You can override the title and subtitle styles, including size, weight, and color.',
        code: '''Ux4gStatusBanner(
        ...
        return StatefulBuilder(
          builder: (ctx, setState) {
            return ComponentDocs(
              ...
              description:
                  'Providing onDismiss shows a × close button on the banner.',
              code:
                  'Ux4gStatusBanner(\n'
                  '  variant: Ux4gBannerVariant.successLight,\n'
                  '  title: \'Changes saved\',\n'
  ...
  useCases: [
    WidgetbookUseCase(
      ...
      builder: (context) => ComponentDocs(
        name: 'Ux4gEmptyState',
        description:
            'A full-page empty state placeholder with icon, title, description, and an optional CTA button.',
        code: '''Ux4gEmptyState(
...
Ux4gEmptyState(
  ...
  onButtonPressed: () {},
        ...
        props: const [
          ...
          PropRow(
            name: 'variant',
            type: 'Ux4gEmptyStateVariant',
            description: 'Semantic preset for the empty state.',
            defaultValue: 'custom',
          ),
          PropRow(
            name: 'subtitle',
          ...
          PropRow(
            name: 'icon',
            type: 'IconData?',
            description: 'Icon displayed above title.',
          ),
          PropRow(
            name: 'iconSize',
            type: 'double?',
          ...
          PropRow(
            name: 'iconColor',
            type: 'Color?',
            description: 'Color of the top icon.',
          ),
          PropRow(
            name: 'titleStyle',
            type: 'TextStyle?',
            description: 'Custom style for the title.',
          ),
          PropRow(
            name: 'bodyStyle',
            type: 'TextStyle?',
            description: 'Custom style for subtitle and description.',
          ),
          PropRow(
            name: 'buttonText',
            type: 'String?',
          ...
          PropRow(
            ...
            type: 'VoidCallback?',
            description: 'CTA button callback.',
          ),
          PropRow(
            name: 'buttonSize',
            type: 'Ux4gButtonSize',
          ...
          PropRow(
            name: 'buttonLeadingIcon',
            type: 'IconData?',
            description: 'Icon shown inside the CTA button.',
          ),
          PropRow(
            name: 'padding',
            type: 'EdgeInsetsGeometry?',
            description: 'Padding around the whole widget.',
            defaultValue: 'EdgeInsets.all(24)',
          ),
          PropRow(
            name: 'bodyHorizontalPadding',
            type: 'double',
            description: 'Extra horizontal padding for text.',
            defaultValue: '24.0',
          ),
        ],
        child: SizedBox(
    ...
    WidgetbookUseCase(
      ...
      builder: (context) => ComponentDocs(
        ...
        description:
            'Providing buttonText and onButtonPressed adds a primary action button.',
        code:
            'Ux4gEmptyState(\n'
            '  title: \'Nothing here yet\',\n'
            '  icon: Icons.inbox_outlined,\n'
        ...
        return StatefulBuilder(
          builder: (ctx, setState) {
            return ComponentDocs(
              name: 'Ux4gChoiceChip',
              description:
                  'Single-select chips. Exactly one option is active at a time.',
              code: '''Ux4gChoiceChip(
  text: 'Option A',
  selected: selected == 0,
  onClick: () => setState(() => selected = 0),
              ...
              props: const [
                ...
                PropRow(
                  name: 'selected',
                  type: 'bool',
                  description: 'Whether this chip is active.',
                  required: true,
                ),
                PropRow(
                  name: 'onClick',
                ...
                PropRow(
                  name: 'leadingContent',
                  type: 'Widget?',
                  description: 'Optional icon or widget before text.',
                ),
                PropRow(
                  name: 'borderRadius',
                  type: 'double',
                  description: 'Corner radius.',
                  defaultValue: 'Ux4gRadius.radius4',
                ),
                PropRow(
                  name: 'selectedBackgroundColor',
                  type: 'Color?',
                  description: 'Background when selected.',
                ),
                PropRow(
                  name: 'unselectedBackgroundColor',
                  type: 'Color?',
                  description: 'Background when unselected.',
                ),
                PropRow(
                  name: 'selectedBorderColor',
                  type: 'Color?',
                  description: 'Border when selected.',
                ),
                PropRow(
                  name: 'unselectedBorderColor',
                  type: 'Color?',
                  description: 'Border when unselected.',
                ),
                PropRow(
                  name: 'selectedTextColor',
                  type: 'Color?',
                  description: 'Text when selected.',
                ),
                PropRow(
                  name: 'unselectedTextColor',
                  type: 'Color?',
                  description: 'Text when unselected.',
                ),
                PropRow(
                ...
                PropRow(
                  name: 'unselectedBorderWidth',
                  type: 'double',
                  description: 'Border width when unselected.',
                  defaultValue: '1',
                ),
              ],
              child: Wrap(
        ...
        return StatefulBuilder(
          builder: (ctx, setState) {
            return ComponentDocs(
              name: 'Ux4gFilterChip',
              description:
                  'Multi-select chips. Any number of options can be active simultaneously.',
              code: '''Ux4gFilterChip(
  text: 'Flutter',
  ...
  onDismiss: () => setState(() => chips.remove('Design')),
              ...
              props: const [
                ...
                PropRow(
                  name: 'onDismiss',
                  type: 'VoidCallback',
                  description: 'Called when × is tapped.',
                  required: true,
                ),
                PropRow(
                  name: 'enabled',
                ...
                PropRow(
                  name: 'size',
                  type: 'Ux4gInputChipSize',
                  description: 'xs, s, or m.',
                  defaultValue: 'm',
                ),
                PropRow(
                  name: 'leadingContent',
                ...
                PropRow(
                  name: 'textColor',
                  type: 'Color?',
                  description: 'Chip text and icon color.',
                ),
                PropRow(
                  name: 'borderWidth',
                  type: 'double',
              ...
              child: Wrap(
                ...
                children: chips
                    .map(
                      (c) => Ux4gInputChip(
                        text: c,
                        onDismiss: () => setState(() => chips.remove(c)),
                      ),
                    )
                    .toList(),
              ),
        ...
        return StatefulBuilder(
          builder: (ctx, setState) {
            return ComponentDocs(
              name: 'Ux4gInputChipField',
              description:
                  'A text field that allows adding multiple chips/tags.',
  ...
  placeholder: 'Add tag...',
              ...
              props: const [
                ...
                PropRow(
                  name: 'onAddChip',
                  type: 'ValueChanged<String>',
                  description: 'Called when the add button is pressed.',
                  required: true,
                ),
                PropRow(
                  name: 'chips',
                  type: 'List<Widget>',
                  description: 'List of chips to display below the field.',
                  defaultValue: '[]',
                ),
                PropRow(
                  name: 'placeholder',
                ...
                PropRow(
                  name: 'leadingIcon',
                  type: 'Widget?',
                  description: 'Icon at the start of the field.',
                ),
                PropRow(
                  name: 'isDropdown',
                  type: 'bool',
                  description:
                      'Whether to show a dropdown instead of text input.',
                  defaultValue: 'false',
                ),
                PropRow(
                  name: 'dropdownOptions',
                  type: 'List<String>',
                  description: 'Options if isDropdown is true.',
                  defaultValue: '[]',
                ),
              ],
              child: SizedBox(
        ...
        return StatefulBuilder(
          builder: (ctx, setState) {
            return ComponentDocs(
              ...
              description:
                  'Wrap layout for chip group — chips flow to next line when space runs out.',
              code: '''Ux4gChipGroup(
  ...
  onPageChange: (i) => setState(() => currentPage = i),
              ...
              props: const [
                ...
                PropRow(
                  ...
                  type: 'int',
                  description: 'Zero-based active page index.',
                  required: true,
                ),
                PropRow(
                  name: 'onPageChange',
                  type: 'ValueChanged<int>',
                  description: 'Called when dot is tapped.',
                  required: true,
                ),
                PropRow(
                  name: 'showArrows',
                  type: 'bool',
                  description: 'Show prev/next chevron buttons.',
                  defaultValue: 'true',
                ),
                PropRow(
                  name: 'variant',
                  type: 'Ux4gPaginationVariant',
                  description: 'defaultVariant or capsule.',
                  defaultValue: 'defaultVariant',
                ),
                PropRow(
                  name: 'size',
                  type: 'Ux4gPaginationSize',
                ...
                PropRow(
                  name: 'inactiveColor',
                  type: 'Color?',
                  description: 'Background of inactive dots.',
                ),
                PropRow(
                  name: 'inactiveBorderColor',
                  type: 'Color?',
                  description: 'Border of inactive dots.',
                ),
              ],
              child: Ux4gPaginationIndicator(
                totalPageCount: context.knobs.int.input(
                  label: 'Count',
                  initialValue: 5,
                ),
