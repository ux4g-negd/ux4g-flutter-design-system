"""Fix broken string literals in the How to use + body sections."""
import os
...
# Find the "How to use" section start and the end of themeColorComponent
...
# The section to replace is content[start_idx : end_idx]
# Replacement uses triple-quoted Dart strings to avoid newline issues
...
Container(color: Ux4gPalette.neutral1000black) // #000000\\'\\'\\',
        ...
        trailingSections: const [
          _DocSection(
            ...
            body: \\'\\'\\'Ux4gColors holds semantic tokens that automatically switch value '
...
# Fix the escaped triple quotes - replace \\'\\'\\' with ''' in the output
